...
bool amr_interfaces__msg__ai_alert__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_interfaces.msg._ai_alert.AiAlert", full_classname_dest, 36) == 0);
  }
  amr_interfaces__msg__AiAlert * ros_message = _ros_message;
  {  // stamp
  ...
  {  // alert_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "alert_type");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->alert_type, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of AiAlert */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_interfaces.msg._ai_alert");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AiAlert");
  ...
  {  // alert_type
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->alert_type.data,
      strlen(ros_message->alert_type.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "alert_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
