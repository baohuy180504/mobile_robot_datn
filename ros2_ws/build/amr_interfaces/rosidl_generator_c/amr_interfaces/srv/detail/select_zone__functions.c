...
amr_interfaces__srv__SelectZone_Request__init(amr_interfaces__srv__SelectZone_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->zone_name)) {
    amr_interfaces__srv__SelectZone_Request__fini(msg);
    return false;
  }
  return true;
}
...
amr_interfaces__srv__SelectZone_Request__create()
{
  ...
  amr_interfaces__srv__SelectZone_Request * msg = (amr_interfaces__srv__SelectZone_Request *)allocator.allocate(sizeof(amr_interfaces__srv__SelectZone_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(amr_interfaces__srv__SelectZone_Request));
  bool success = amr_interfaces__srv__SelectZone_Request__init(msg);
  if (!success) {
...
amr_interfaces__srv__SelectZone_Request__Sequence__init(amr_interfaces__srv__SelectZone_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  amr_interfaces__srv__SelectZone_Request * data = NULL;

  if (size) {
    data = (amr_interfaces__srv__SelectZone_Request *)allocator.zero_allocate(size, sizeof(amr_interfaces__srv__SelectZone_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = amr_interfaces__srv__SelectZone_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        amr_interfaces__srv__SelectZone_Request__fini(&data[i - 1]);
      }
...
amr_interfaces__srv__SelectZone_Request__Sequence__fini(amr_interfaces__srv__SelectZone_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      amr_interfaces__srv__SelectZone_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  amr_interfaces__srv__SelectZone_Request__Sequence * array = (amr_interfaces__srv__SelectZone_Request__Sequence *)allocator.allocate(sizeof(amr_interfaces__srv__SelectZone_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = amr_interfaces__srv__SelectZone_Request__Sequence__init(array, size);
  if (!success) {
...
amr_interfaces__srv__SelectZone_Request__Sequence__destroy(amr_interfaces__srv__SelectZone_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    amr_interfaces__srv__SelectZone_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
amr_interfaces__srv__SelectZone_Request__Sequence__are_equal(const amr_interfaces__srv__SelectZone_Request__Sequence * lhs, const amr_interfaces__srv__SelectZone_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!amr_interfaces__srv__SelectZone_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  amr_interfaces__srv__SelectZone_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(amr_interfaces__srv__SelectZone_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    amr_interfaces__srv__SelectZone_Request * data =
      (amr_interfaces__srv__SelectZone_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!amr_interfaces__srv__SelectZone_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          amr_interfaces__srv__SelectZone_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!amr_interfaces__srv__SelectZone_Request__copy(
...
amr_interfaces__srv__SelectZone_Response__init(amr_interfaces__srv__SelectZone_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    amr_interfaces__srv__SelectZone_Response__fini(msg);
    return false;
  }
  // goal
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  amr_interfaces__srv__SelectZone_Response * msg = (amr_interfaces__srv__SelectZone_Response *)allocator.allocate(sizeof(amr_interfaces__srv__SelectZone_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(amr_interfaces__srv__SelectZone_Response));
  bool success = amr_interfaces__srv__SelectZone_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
amr_interfaces__srv__SelectZone_Response__Sequence__init(amr_interfaces__srv__SelectZone_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  amr_interfaces__srv__SelectZone_Response * data = NULL;

  if (size) {
    data = (amr_interfaces__srv__SelectZone_Response *)allocator.zero_allocate(size, sizeof(amr_interfaces__srv__SelectZone_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = amr_interfaces__srv__SelectZone_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        amr_interfaces__srv__SelectZone_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
amr_interfaces__srv__SelectZone_Response__Sequence__fini(amr_interfaces__srv__SelectZone_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      amr_interfaces__srv__SelectZone_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  amr_interfaces__srv__SelectZone_Response__Sequence * array = (amr_interfaces__srv__SelectZone_Response__Sequence *)allocator.allocate(sizeof(amr_interfaces__srv__SelectZone_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = amr_interfaces__srv__SelectZone_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
amr_interfaces__srv__SelectZone_Response__Sequence__destroy(amr_interfaces__srv__SelectZone_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    amr_interfaces__srv__SelectZone_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
amr_interfaces__srv__SelectZone_Response__Sequence__are_equal(const amr_interfaces__srv__SelectZone_Response__Sequence * lhs, const amr_interfaces__srv__SelectZone_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!amr_interfaces__srv__SelectZone_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  amr_interfaces__srv__SelectZone_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(amr_interfaces__srv__SelectZone_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    amr_interfaces__srv__SelectZone_Response * data =
      (amr_interfaces__srv__SelectZone_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!amr_interfaces__srv__SelectZone_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          amr_interfaces__srv__SelectZone_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!amr_interfaces__srv__SelectZone_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
