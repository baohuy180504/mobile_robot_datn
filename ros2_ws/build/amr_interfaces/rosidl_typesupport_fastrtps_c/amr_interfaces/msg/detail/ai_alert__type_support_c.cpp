...
#include "amr_interfaces/msg/detail/ai_alert__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // alert_type, image_path, message
#include "rosidl_runtime_c/string_functions.h"  // alert_type, image_path, message
...
using _AiAlert__ros_msg_type = amr_interfaces__msg__AiAlert;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AiAlert__ros_msg_type * ros_message = static_cast<const _AiAlert__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AiAlert__ros_msg_type * ros_message = static_cast<_AiAlert__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _AiAlert__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_interfaces__msg__AiAlert(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_interfaces__msg__AiAlert;
    is_plain =
      (
...
static size_t _AiAlert__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_amr_interfaces__msg__AiAlert(
...
static message_type_support_callbacks_t __callbacks_AiAlert = {
  "amr_interfaces::msg",
  "AiAlert",
...
static rosidl_message_type_support_t _AiAlert__type_support = {
